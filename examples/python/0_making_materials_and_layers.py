...
polyethylene = pkc.Material(composition={"H": 2, "C": 1}, density=0.94, fraction="atom")
...
# --- Sources ---
cs137 = pkc.Source("photon", 662e3)
co60 = pkc.Source("photon", [(1173e3, 1.0), (1333e3, 1.0)])
dt_neutron = pkc.Source("neutron", 14.06e6)
dt_dd = pkc.Source("neutron", [(14.06e6, 95), (2.45e6, 5)])

print(f"Sources: {cs137}, {co60}, {dt_neutron}, {dt_dd}")

# --- Layers ---
single = [pkc.Layer(thickness=100, material=concrete)]
multi = [
    pkc.Layer(thickness=500),
    pkc.Layer(thickness=20, material=polyethylene),
