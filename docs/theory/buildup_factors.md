...
- **Material mixing**: Tables exist per element (photons) or per isotope (neutrons). Combining them for a compound material introduces approximation error from the mixing rule.
